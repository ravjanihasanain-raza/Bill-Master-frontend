...
export default function StaffMaster() {
  ...
  const processedData = useMemo(() => {
    ...
    return result;
  }, [updatedStaff, search, fromDate, toDate, sortOrder]);
            ...
            {initialLoad ? (
              ...
              <>
                <KpiCard $accent="#3b82f6">
                  ...
                  <KpiBody>
                    <KpiLabel>Total Staff</KpiLabel>
                    <KpiValue>
                      <AnimatedNumber value={totalStaff} />
                    </KpiValue>
                    <KpiSub>Registered Employees</KpiSub>
                  </KpiBody>
                ...
                <KpiCard $accent="#10b981">
                  ...
                  <KpiBody>
                    <KpiLabel>Active Staff</KpiLabel>
                    <KpiValue>
                      <AnimatedNumber value={activeStaff} />
                    </KpiValue>
                    <KpiSub style={{ color: "#10b981" }}>Active System Access</KpiSub>
                  </KpiBody>
                ...
                <KpiCard $accent="#f59e0b">
                  ...
                  <KpiBody>
                    <KpiLabel>New Joinings</KpiLabel>
                    <KpiValue>
                      <AnimatedNumber value={newStaff} />
                    </KpiValue>
                    <KpiSub>Joined in last 30 days</KpiSub>
                  </KpiBody>
                      ...
                      >
                        <Td>
                          <ProfileCell>
                            ...
                            <div>
                              <div className="fw-bolder">{s.fullName}</div>
                              <span className="sub">
                        ...
                        <Td center>
                          <StatusBadge $active={s.displayStatus === "Active"}>
                            {s.displayStatus === "Active" ? "Active" : "Inactive"}
                          </StatusBadge>
                        </Td>
                        <Td center>
                          <ActionsGroup>
                            <ActionBtn
                              $type="edit"
                              title={isFyLocked ? "Financial year locked" : "Edit Staff"}
                            ...
                            <ActionBtn
                              $type="delete"
                              title={isFyLocked ? "Financial year locked" : "Delete Staff"}
              ...
              >
                ...
                >
                  <ModalHead>
                    ...
                    <ModalTitle>
                      {form.id > 0 ? "Edit Staff Profile" : "New Staff Profile"}
                    </ModalTitle>
                    <CloseBtn
                      onClick={() => {
                        if (!submitLoading) {
                  ...
                  <ModalBody>
                    <FormRow>
                      <FormGroup>
                        <FormLabel>Full Name <Required>*</Required></FormLabel>
                        <FormInput
                          name="fullName"
                          value={form.fullName}
                      ...
                      <FormGroup>
                        <FormLabel>Role <Required>*</Required></FormLabel>
                        <FormInput
                          name="role"
                          value={form.role}
                          onChange={handleChange}
                      ...
                      <FormGroup>
                        <CheckboxLabel>
                          <HiddenCheckbox
                            ...
                            disabled={submitLoading}
                          />
                          <StyledCheckbox $checked={form.status}>
                            <CheckCircle2 size={14} color="white" style={{ opacity: form.status ? 1 : 0 }} />
                          </StyledCheckbox>
                          <span>Active System Access</span>
                        </CheckboxLabel>
                      </FormGroup>
                    </FormRow>
                  </ModalBody>
...
const StatusBadge = styled.span`
  ...
  border: 1px solid ${(p) => (p.$active ? "rgba(16, 185, 129, 0.25)" : "rgba(239, 68, 68, 0.25)")};
`;
...
const StyledCheckbox = styled.div`
  ...
  width: 20px;
  height: 20px;
  background: ${(p) => (p.$checked ? "var(--primary)" : "var(--bg-light-custom)")};
  border: 1px solid ${(p) => (p.$checked ? "var(--primary)" : "var(--border-custom)")};
  border-radius: 6px;
  transition: all 0.2s ease;
  display: flex;
  align-items: center;
